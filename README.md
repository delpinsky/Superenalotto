...
[![Version](https://img.shields.io/badge/versione-v1.0.33-blue)]()
...
#### ✨ `index.html` — Allarme numeri recenti nella schedina
...
- **Nessun dato aggiuntivo richiesto** — legge direttamente le ultime 2 estrazioni dall'array `draws[]` già in memoria, ordinate per data decrescente (v1.0.33a)
- **Allarme esteso alla griglia di selezione** — i numeri usciti nelle ultime 2 estrazioni appaiono con bordo rosso e numero rosso anche nella griglia "Scegli 6 numeri", sia in modalità 1 numero che 6 numeri; lo sfondo rimane invariato (v1.0.33b)
- **Allarme esteso al Sistema di Gioco** — i numeri usciti nelle ultime 2 estrazioni appaiono con bordo rosso e numero rosso anche nella griglia del Sistema Integrale e Ridotto; rimosso il grassetto dai numeri selezionati (v1.0.33c)
